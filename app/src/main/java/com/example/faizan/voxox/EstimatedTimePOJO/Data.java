package com.example.faizan.voxox.EstimatedTimePOJO;
...
public class Data {
    ...
    @Expose
    private List<Object> estimated = null;
    ...
    public List<Object> getEstimated() {
        return estimated;
    }

    public void setEstimated(List<Object> estimated) {
